...
void medicineType::order_list() //Function to display receipt
{
    ...
    while (temp != NULL && !found)
    {
        ...
        if (found) //print the receipt
        {
            ...
            temp->total = temp->amount[0] + temp->amount[1] + temp->amount[2] +
                          temp->amount[3] + temp->amount[4] + temp->amount[5] +
                          temp->amount[6] + temp->amount[7] + temp->amount[8] + temp->amount[9];
